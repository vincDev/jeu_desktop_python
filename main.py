...
class MainWidget(RelativeLayout):
    ...
    V_NB_LINES = 8
    V_LINES_SPACING = .25  # pourcentage dans l'ecran
    vertical_lines = []

    H_NB_LINES = 20
    H_LINES_SPACING = .2  # pourcentage dans l'ecran
    horizontal_lines = []
    ...
    def reset_game(self):
        ...
        self.pre_fille_tiles_coordinates()
    ...
    def update_ship(self):
        ...
        x1, y1 = self.transform(*self.ship_coordinates[0])  # * permet d'ouvrir la liste
    ...
    def pre_fille_tiles_coordinates(self):
    ...
    def get_line_x_from_index(self, index):
        ...
        offset = index - 0.5
        line_x = int(centrale_line_x + offset * spacing + self.current_offset_x)
        return line_x
